...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="w-full bg-gray-100 text-black py-2 text-sm flex justify-between items-center px-6 md:px-12 fixed top-0 left-0 right-0 z-50">
        ...
        <div className="container mx-auto flex justify-between items-center py-3 px-6">
          ...
          {isMobileMenuOpen && (
            <div className="absolute top-full left-0 w-full bg-white shadow-lg border-t md:hidden flex flex-col items-center space-y-4 py-4 z-50">
              ...
              <Link href="/solutions" className="hover:text-gray-500">
                Solutions
              </Link>
              <Link href="/partners" className="hover:text-gray-500">
                Partners
              </Link>
              <Link href="/support" className="hover:text-gray-500">
                Support
              </Link>
              <Link href="/explore" className="hover:text-gray-500">
                Explore
              </Link>
            </div>
          )}
          ...
          <Button
            variant="default"
            className="hidden md:block bg-blue-600 text-white"
          >
            Contact Sales
          </Button>
        </div>
